...
@ServerEndpoint(value = "/profesores", decoders = {JsonObjectDecoder.class}, encoders = {JsonObjectEncoder.class})
public class ProfesorEndpoint {
    private static final ProfesorController controller = ProfesorController.getInstance();
