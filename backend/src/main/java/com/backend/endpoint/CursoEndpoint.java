...
import com.backend.controller.CursoController;
...
@ServerEndpoint(value = "/cursos", decoders = {JsonObjectDecoder.class}, encoders = {JsonObjectEncoder.class})
public class CursoEndpoint {
    private static final CursoController controller = CursoController.getInstance();
