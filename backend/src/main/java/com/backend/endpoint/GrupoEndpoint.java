...
import com.backend.controller.GrupoController;
...
@ServerEndpoint(value = "/grupos", decoders = {JsonObjectDecoder.class}, encoders = {JsonObjectEncoder.class})
public class GrupoEndpoint {

    private static final GrupoController controller = GrupoController.getInstance();
