...
import com.backend.controller.CarreraController;
import com.backend.controller.CursosCarreraController;
...
@ServerEndpoint(value = "/cursosCarreras", decoders = {JsonObjectDecoder.class}, encoders = {JsonObjectEncoder.class})
public class CursosCarreraEndpoint {

    private static final CursosCarreraController controller = CursosCarreraController.getInstance();
