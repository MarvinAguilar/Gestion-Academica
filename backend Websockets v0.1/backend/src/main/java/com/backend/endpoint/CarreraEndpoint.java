...
@ServerEndpoint(value = "/carreras", decoders = {JsonObjectDecoder.class}, encoders = {JsonObjectEncoder.class})
public class CarreraEndpoint {
    private static final CarreraController controller = CarreraController.getInstance();
