...
class AdaptadorProfesores(private var items: ArrayList<Profesor>) : RecyclerView.Adapter<RecyclerView.ViewHolder>(),
    Filterable {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        holder.itemView.findViewById<TextView>(R.id.tv_field3)?.text = item?.email
